...
#	Makefile for QFlow of sample project "array_multiplier", target tech. ETRI 0.5um CMOS
#
...
all :
	@echo 'Makefile for "array_multiplier": QFlow from RTL to Layout using ETRI 0.5um CMOS Technology'
